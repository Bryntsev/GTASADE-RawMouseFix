...
Текущая сборка тестировалась автором в режиме DX12. Если игра не запускается в DX12 по умолчанию или мод работает не так, как ожидается, попробуйте добавить параметр запуска Steam:
